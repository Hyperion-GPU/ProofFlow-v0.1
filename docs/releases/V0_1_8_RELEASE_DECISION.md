...
v0.1.8 is ready to publish after the final release-notes PR is merged. The
GitHub Release body should use
[`docs/releases/V0_1_8_RELEASE_NOTES.md`](V0_1_8_RELEASE_NOTES.md) as the
source text.
...
| --- | --- | --- |
| Release notes | PASS | `docs/releases/V0_1_8_RELEASE_NOTES.md` covers highlights, main flow, dogfood evidence, validation, breaking changes, and intentionally excluded scope. |
...
The final GitHub Release should use the release notes as source material:
